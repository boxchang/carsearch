...
urlpatterns = [
    ...
    url(r'^photo_upload_record_api/$', photo_upload_record_api, name='photo_upload_record_api'),
    url(r'^car_download_record_api/$', car_download_record_api, name='car_download_record_api'),
